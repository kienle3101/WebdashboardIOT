...
export default function AdminHistoryPage() {
  ...
  const { data: response = { data: [], total: 0, pageNo: 1, pageSize: 5 }, isLoading } = useActivityLogs({ pageNo, pageSize });
  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #eef0f3', borderRadius: 14, padding: 18 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, marginBottom: 16, flexWrap: 'wrap' }}>
        <div>
          <div style={{ fontWeight: 700, fontSize: 20 }}>Lịch sử sử dụng</div>
